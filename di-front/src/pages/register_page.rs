    ...
    <section class="py-8 bg-ct-blue-600 min-h-screen grid place-items-center">
      <div class="w-full">
        ...
        <h2 class="text-lg text-center mb-4 text-ct-dark-200">
          ...
          >
            <FormInput input_type="" label="Full Name" name="name" input_ref={name_input_ref} handle_onchange={handle_name_input}  errors={&*validation_errors} handle_on_input_blur={validate_input_on_blur.clone()} />
            ...
            <LoadingButton
              ...
              text_color={"text-ct-blue-600".to_string()}
            >
             {" Sign Up"}
            </LoadingButton>
          </form>
